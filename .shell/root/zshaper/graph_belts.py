...
def main():
    ...
    opts.add_option("--zh", action="store_true", dest="en_lang", default=False, help="Use English output")
    opts.add_option("--ja", action="store_true", dest="en_lang", default=False, help="Use English output")
    opts.add_option("--ko", action="store_true", dest="en_lang", default=False, help="Use English output")
    ...
    opts.add_option("--tr", action="store_true", dest="en_lang", default=False, help="Use English output")
