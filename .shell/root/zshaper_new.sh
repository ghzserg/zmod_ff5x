...
[ ${ZLANG} == 'en' ] && echo "Preparing X-axis image. Please wait..." || echo "Подготовка изображения оси X. Ждите..."
...
[ ${ZLANG} == 'en' ] && echo "Preparing Y-axis image. Please wait..." || echo "Подготовка изображения оси Y. Ждите..."
...
[ ${ZLANG} == 'en' ] && echo "Images are available in Configuration -> mod_data resonances_x.png and resonances_y.png." || echo "Изображения лежат во вкладке Конфигурация -> mod_data resonances_x.png и resonances_y.png."
